...
/******/ 	var hotCurrentHash = "e2e02d7d60898b5aef55"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let oneObj = [
		{img:__webpack_require__(55),name:'One home'},
		{img:__webpack_require__(46),name:'A few homes <br> (1-9 homes)'},
		{img:__webpack_require__(54),name:'Many homes <br> (10+homes)'}
	]
	...
	function one(){
		...
		oneObj.map((item,index)=>{
			html += `<td><div id="${index}" class="box one_box ${index == 0 ? 'active':''}"><div class="icon"><img src="${item.img}"/></div><div class="text">${item.name}</div></div></td>`
		})
		...
		$(".one .common_content_btn").click((e)=>{
			_data.homeNumState = $(".one .active").attr('id');
			_state = 2;
			renderPage()
		})
	}
	...
	function two(){
		...
		$(".two .common_content_btn").click((e)=>{
			_data.address = $(".two #address").val();
			_data.studio = $(".two .active .num").text();
			if(_data.address==""){
				$("#modal_text").text("Please enter the address！")
				showModal()
				return false
			}
			_state = 3;
	...
	function three(){
		...
		$(".three .common_content_btn").click((e)=>{
			_data.firstName = $(".three #firstName").val();
			_data.lastName = $(".three #lastName").val();
			_data.phone = $(".three #phone").val();
			_data.city = $(".three #city").val();
		
			
			if(_data.firstName==""){
				$("#modal_text").text("Please enter the first name！")
				showModal()
				return false
			}
		
			if(_data.lastName==""){
				$("#modal_text").text("Please enter the last name！")
				showModal()
				return false
			}
		
			if(_data.phone==""){
				$("#modal_text").text("Please enter right the phone number！")
				showModal()
				return false
			}
		
			if(_data.city==""){
				$("#modal_text").text("Please enter right the city！")
				showModal()
				return false
			}
			$("#modal_text").text("SUCCESS！")
			sendMsg()
		})
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/0c356991bd225b8153e325c6c3276b88.png";

/***/ }),
/* 11 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/bb49c7d5bf52573ab485fe1423248d5d.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let phone_icon = __webpack_require__(11);
	let phone_location = __webpack_require__(10);
	
	! function() { 
		//<a alt="locals" href="'+parentUrl+'/view/contactUs.html"><li>Contact Us</li></a>
		var parentUrl = utils.parentUrl;
		var i = '\t<a  alt="locals" href="'+parentUrl+'/index.html" title="locals 路客精品民宿"> <div  class="top-logo"  id="#logo" ></div> </a> <div class="top-nav" id="top-nav"> <ul>  <a alt="locals" class="nav_a" href="'+parentUrl+'/view/getStar.html"><li>Get Start</li><div class="line"></div></a><a class="nav_a" alt="locals" href="'+parentUrl+'/view/pricing.html"><li>Pricing</li><div class="line"></div></a> <a alt="locals" class="nav_a" href="'+parentUrl+'/view/whoWeAre.html"><li>Who we are</li><div class="line"></div></a>  <a  class="nav_a" alt="locals" href="'+parentUrl+'/view/whatWeDo.html"><li>What we do</li><div class="line"></div></a> <a class="nav_a" alt="locals" href="'+parentUrl+'/index.html"><li>Home</li><div class="line"></div></a></ul> </div>';
		var t = '\t<p><div class="footer-title">Travel like a local ，We are locals</div><img src="'+phone_icon+'" class="footer-phone"/>Tel：4009999270 <span></span> <img src="'+phone_location+'" class="footer-location"/>Guangzhou, China <div class="footer-right-box"></div></p>';
