...
/***/ (function(module, exports, __webpack_require__) {
	...
	function buildHeadImg(){
		let arr = [
			{img:__webpack_require__(56),name:'Tongmin Su'}
			,{img:__webpack_require__(59),name:'Xiaoping XU'}
			,{img:__webpack_require__(60),name:'Minhong Yu'}
			,{img:__webpack_require__(39),name:'Jun Lei'}
		]
		arr.map((item,index)=>{
